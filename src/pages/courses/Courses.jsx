...
import avatar1 from "../../assets/images/userStatic/avatar-s-5.jpg";
import avatar2 from "../../assets/images/userStatic/avatar-s-6.jpg";
import avatar3 from "../../assets/images/userStatic/avatar-s-7.jpg";
                    ...
                    <UncontrolledDropdown>
                      ...
                      <DropdownMenu>
                        <DropdownItem
                          ...
                          onClick={(e) => {
                            e.preventDefault();
                            activeDeActive({ id: item.courseId, active: true });
                            activeDeActiveDone(
                        ...
                        <DropdownItem
                          ...
                          onClick={(e) => {
                            ...
                            activeDeActiveDone(
                              toast("دوره با موفقیت غیر فعال شد", {
                                icon: (
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    x="0px"
                            ...
                            activeDeActiveErr(
                              toast("غیر فعال کردن دوره دچار مشکل است", {
                                icon: (
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    x="0px"
