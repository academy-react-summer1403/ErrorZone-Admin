...
import { TechnologhyColumns } from "../@core/components/technologhy/TechnologhyColumns";
...
const Technologhy = () => {
  ...
  const { data: list, refetch } = useQueryGet(["Technology"], "/Technology");
  ...
  return (
    <>
      ...
      <Card>
        <CardHeader tag="h4"> تکنولوژی ها </CardHeader>
        <div className="react-dataTable user-view-account-projects">
          {list?.length === 0 ? (
            <span className="no-user-course-reserve-found-text">
              متاسفانه تکنولوژی پیدا نشد
            </span>
          ) : (
            <>
              ...
              <DataTable
                ...
                columns={TechnologhyColumns(refetch)}
