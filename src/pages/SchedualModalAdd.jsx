...
import { useMutationPostOnSuccesOpt } from "../customHook/useMutationPost";
import { useQueryClient } from "@tanstack/react-query";
//import { AddJobs } from "../../../core/services/Paper";

const SchedualModalAdd = ({
  id,
  data,
  currentCourseId,
  courseGroupId,
  ...
  } = useMutationPostOnSuccesOpt(
    `/Schedual/AddSchedualSingle?currentCurseId=${currentCourseId}`,
    () => queryClient.invalidateQueries(["courseGroupDetail"])
  );
...
export default SchedualModalAdd;
