...
const changeNewsStatus = (
  ...
  changeStatus({ "CourseId": item.id, "StatusId": statusId });
  changeStatusDone(
    toast(`وضعیت دوره با موفقیت به ${toastKeyMassage} تغییر یافت`, {
      icon: (
        <svg
  ...
  changeStatusErr(
    toast("تغییر وضعیت دوره با مشکل مواجه شد ", {
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
...
export default changeNewsStatus;
