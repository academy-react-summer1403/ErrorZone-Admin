...
const CourseAdminComments = () => {
  ...
  const isAcceptOptions = [
   ...
   //const { data:CourseComments } = useQueryGet(["CourseComments"] , "/Course/CommentManagment?PageNumber=1&RowsOfPage=10&SortingCol=DESC&SortType=InsertDate&Query=&Accept=&userId=")

   //const list = CourseComments?.comments
...
export default CourseAdminComments
