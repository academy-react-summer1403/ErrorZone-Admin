...
import { renderRoleName } from "../../../utility/hooks/render-role-name-helper.utils";
import Chart from "react-apexcharts";
import { deleteUserAPI } from "../../../core/services/Paper";
import UserAddRole from "../userAddRoles/userAddRole";
  ...
  if (row.pictureAddress) {
    ...
    return (
      <Avatar
        ...
        className="me-1"
        color={"light-primary"}
        content={row.fname + " " + row.lname || "کاربر دنجر"}
      />
    );
  }
};
