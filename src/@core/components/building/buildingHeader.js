...
//** Table Header
const CustomBuildinHeader = ({ setSearched ,toggleSidebar, handlePerPage, rowsPerPage ,toggle , isOpen }) => {
        ...
        <Row>
          ...
          >
            ...
            <Formik 
              ...
              <Button color='primary'  type='submit' style={{marginRight: "10px"}}   onClick={(e) => {
                                   e.preventDefault();
                                   toggle();
                             }}>اضافه کردن ساختمان
              </Button>  
  ...
  export default CustomBuildinHeader