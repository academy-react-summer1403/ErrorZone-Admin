...
const UpdatingBuilding = ({ show, setShow, item }) => {
  ...
  return (
    ...
    >
      ...
      <ModalBody className="">
        <div className="">
          <h1 className="mb-1">
            {item ? "بروزرسانی  ساختمان" : "افزودن ساختمان "}{" "}
          </h1>
        ...
        >
          {({ handleChange, values, errors, touched, setFieldValue }) => (
            ...
            >
              ...
              <div className="mb-1 w-40">
                <Label for="active">
                  فعال کردن دوره؟<span className="text-danger">*</span>
                </Label>
                <Input
                  id="active"
                  name="active"
              ...
              <Button type="reset" color="secondary" outline toggle={() => setShow(!show)}>
                انصراف
              </Button>
            </Form>
          )}
...
export default UpdatingBuilding;
