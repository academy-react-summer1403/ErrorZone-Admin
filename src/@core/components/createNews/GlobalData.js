...
import { createNewsFormSchema } from "../../../core/Validation/News/create-news-form.validation";
import { getListNewsCategory } from "../../../core/services/Paper";
...
const GlobalData = ({
  ...
  useEffect(() => {
    const fetchNewsCategoryLists = async () => {
      try {
        const getNewsCategoryLists = await getListNewsCategory();
        console.log('1212212212' , getNewsCategoryLists)
