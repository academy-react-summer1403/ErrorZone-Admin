...
import { UpdatingJobs } from "../../../core/services/Paper";

const UpdateJobs = ({ show, setShow, refetch , selectedItem }) => {
  ...
  const onSubmit = async (data) => {
    ...
    const response = await UpdatingJobs(dataObj);
        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          <Row>
            ...
            <Col lg="12" className="mb-1">
              ...
              <Controller
                defaultValue={selectedItem?.workStartDate}
                id="workStartDate"
                name="workStartDate"
                control={control}
                render={({ field }) => (
            ...
            <Col lg="12" className="mb-1">
              ...
              <Controller
                defaultValue={selectedItem?.workEndDate}
                id="workEndDate"
                name="workEndDate"
                control={control}
                render={({ field }) => (
            ...
            <Col lg="12" className="mb-1">
              ...
              <Controller
                id="inWork"
                name="inWork"
                defaultValue={selectedItem?.inWork}
                control={control}
                render={({ field }) => (
                  <Input
                   type="radio"
